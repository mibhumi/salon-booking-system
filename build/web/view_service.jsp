<%-- 
    ...
    Created on : Nov 16, 2018, 12:29:27 AM
    Author     : admin
--%>
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">View Service</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"> <a href="http://localhost:8080/SBS/add_service.html"><i class="icon icon-th-list"></i> <span>Service</span></a>
      <ul>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Staff</a> <a href="#" class="current">Staff Detail</a> </div>
  </div>
              ...
              <tbody>
                ...
                <tr class="gradeC">
                  ...
                  <td>Internet
                    Explorer 5.0</td>
                  <td>Win 95+</td>
                  <td class="center"><i class="fas fa-edit"></i>
                  <i class="fas fa-eye"></i>
                  <i class="fas fa-trash-alt"></i>
                </td>
                </tr>
