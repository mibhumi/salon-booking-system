<%-- 
    Document   : add_staff
    Created on : Nov 16, 2018, 12:28:03 AM
    Author     : admin
--%>
...
<!--Header-part-->
<div id="header">
  <h1><a href="http://localhost:8080/SBS/add_service.html">Staff Registration</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Staff</a> <a href="http://localhost:8080/SBS/add_staff.html" class="current">Staff Registration</a> </div>
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Staff Number</label>
              <div class="controls">
