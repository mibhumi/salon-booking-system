<%-- 
    Document   : view_staff
    Created on : Nov 16, 2018, 12:29:10 AM
    Author     : admin
--%>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Staff Detail</a> </div>
    <h1>Tables</h1>
  </div>
